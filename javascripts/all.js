...
ready = function (f) { if (readies) readies.push(f); else f() }; readies = []; document.onreadystatechange = function (ev) { document.onreadystatechange = null; readies.forEach(function (f) { f() }); readies = null };
